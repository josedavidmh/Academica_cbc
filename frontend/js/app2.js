    ...
    let url = host+"consulta_general/"+variable;
              ...
              const visualizar = (data) => {
                  ...
                  for (var i = 0; i < data.datos.length; i++) { 
                     ...
                     b+=`<td><button type='button' class="btn btn-info" onclick="location.href = 'edit.html?variable1=${variable}&variable2=${data.datos[i][0]}'"> <img src='img/edit.png' height ='30' width='30'/></button>
                     <button type='button' class="btn btn-warning" onclick="eliminar(${data.datos[i][0]})"> <img src='img/delete.png' height ='30' width='30'/></button></td></tr>`    
                    }
                    b2="";
